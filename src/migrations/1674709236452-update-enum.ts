...
export class updateEnum1674709236452 implements MigrationInterface {
  name = 'updateEnum1674709236452'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."category_trailing_return_period_enum" AS ENUM('1d', '1m', '3m', '1y', 'ytd')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."strategy_trailing_return_period_enum" AS ENUM('1d', '1m', '3m', '1y', 'ytd')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."strategy_risk_and_volatility_period_enum" AS ENUM('1d', '1m', '3m', '1y', 'ytd')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."index_risk_and_volatility_period_enum" AS ENUM('1d', '1m', '3m', '1y', 'ytd')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."index_trailing_return_period_enum" AS ENUM('1d', '1m', '3m', '1y', 'ytd')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."category_risk_and_volatility_period_enum" AS ENUM('1d', '1m', '3m', '1y', 'ytd')`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."category_risk_and_volatility_period_enum_old" AS ENUM('1d', '1m', '3m', '1y')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."index_trailing_return_period_enum_old" AS ENUM('1d', '1m', '3m', '1y')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."index_risk_and_volatility_period_enum_old" AS ENUM('1d', '1m', '3m', '1y')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."strategy_risk_and_volatility_period_enum_old" AS ENUM('1d', '1m', '3m', '1y')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."strategy_trailing_return_period_enum_old" AS ENUM('1d', '1m', '3m', '1y')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."category_trailing_return_period_enum_old" AS ENUM('1d', '1m', '3m', '1y')`,
    )
    await queryRunner.query(
